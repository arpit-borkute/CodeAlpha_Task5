...
public class AdminController {
	...
	public String saveEmployee(Employee employee, RedirectAttributes redirectAtt, HttpSession session)
	...
	public String viewLeaveDetails(Model model, @PathVariable(name = "empId") int empId, HttpSession session)
			throws EmployeeNotFoundException, java.sql.SQLSyntaxErrorException {
		if (session.getAttribute("id") != null) {
			try {
	...
	public String checkStatus(Model model, @PathVariable(name = "employeeId") int empid, RedirectAttributes att,
	...
	// employee apply leave form getting saved and diffrenet validations are being
	// checked
	@PostMapping("/employees/apply/save")
	public String saveEmpLeave(Model model, ApplyLeave obj, RedirectAttributes att, HttpSession session)
			throws EmployeeNotFoundException {
	...
	// admin can approve pending leave and then that leave will be decremented from
	// table storing leaves for employees
	@GetMapping("/employees/leave/allleaves/updatepending/{leaveid}")
	public String updatePendingLeave(@PathVariable(name = "leaveid") int leaveid, RedirectAttributes att,
			HttpSession session) {
